...
$theme_options = array (
	...
	array(
		'id'      => 'theme_sidebars_style_nav',
		'name'    => __('Nav sidebars', THEME_NS),
		'type'    => 'select',
		'options' => $theme_sidebars_style_options
	),
	array(
...
$theme_page_meta_options = array (
    array(
		...
		'name' => __('Show in Pages Menu', THEME_NS) . sprintf('<br /><small>%s</small>', __('(Not for Custom Menu)', THEME_NS)),
		'desc' => __('Yes', THEME_NS),
		'type' => 'checkbox'
	),
	array(
		'id'   => 'theme_show_as_separator',
		'name' => __('Show as Separator in Pages Menu', THEME_NS) . sprintf('<br /><small>%s</small>', __('(Not for Custom Menu)', THEME_NS)),
		'desc' => __('Yes', THEME_NS),
		'type' => 'checkbox'
	),
	array(
		'id'   => 'theme_title_in_menu',
		'name' => __('Title in Pages Menu', THEME_NS) . sprintf('<br /><small>%s</small>', __('(Not for Custom Menu)', THEME_NS)),
		'type' => 'widetext'
	),
	array(
	...
	array(
		...
		'name' => __('Use <a href="http://codex.wordpress.org/Function_Reference/wpautop">wpautop</a>', THEME_NS),
		'desc' => __('Yes', THEME_NS),
		'type' => 'checkbox'
	),
		array(
	...
	array(
		'id'   => 'theme_layout_template_default_sidebar',
		'name' => __('Show Default Sidebar on Page', THEME_NS),
		'desc' => __('Yes', THEME_NS),
		'type' => 'checkbox'
	),
