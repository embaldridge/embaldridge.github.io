...
<?php theme_ob_start() ?><a title="RSS" class="art-rss-tag-icon" style="position: absolute; bottom: 20px; left: 6px; line-height: 32px;" href="#"></a><?php echo do_shortcode(theme_ob_get_clean()) ?><div style="position:relative;padding-left:10px;padding-right:10px"><p><a href="http://weecology.org/">Weecology</a> | <a href="http://whitelab.weecology.org/">White Lab</a>&nbsp;</p>
